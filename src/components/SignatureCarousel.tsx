...
const ITEMS: Item[] = [
  {
    ...
    image: img01,
    tags: ["₹8 Cr+ revenue", "Day 15 first sale", "100% ship"],
  },
  {
    id: "creator",
    number: "N°02",
  ...
  },
  {
    id: "sif",
    number: "N°03",
    category: "Capital · Term 3",
    term: "Full term",
    title: "Trade real capital. Defend real theses.",
    role: "Public markets · PM-led",
    description:
      "A student-run fund with a live corpus. Build a coverage universe, defend picks weekly at IC, and get marked to market like a real desk.",
    image: img03,
    tags: ["Live corpus", "Weekly IC", "PM mentors"],
  },
  {
    id: "vip",
    number: "N°04",
  ...
  },
  {
    id: "corp",
    number: "N°05",
    category: "Corporate · Year-round",
    term: "24 hours",
    title: "CEO-set briefs. Solved in a single day.",
    role: "Board-level problems",
    description:
      "Sitting CEOs walk in with a real problem in the morning. You present your recommendation to them by evening — 40+ companies annually.",
    image: img05,
    tags: ["24-hr turnaround", "40+ companies", "Boardroom"],
  },
  {
    id: "global",
    number: "N°06",
