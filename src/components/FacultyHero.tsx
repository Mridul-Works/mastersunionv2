...
const PHOTO_CLASS =
  "h-full w-full origin-center object-cover object-[40%_15%] contrast-[1.05] md:object-[50%_22%] md:scale-[1.22] lg:object-[60%_28%] lg:scale-[1.28] scale-[1.18] will-change-transform";
