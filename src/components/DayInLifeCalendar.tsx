...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    bg: "#1E1E1E", fg: "#FFF", border: "#F4C641",
...
const LEGEND: { tag: Tag; bg: string; fg: string }[] = [
  { tag: "VENTURE", bg: "#F4C641", fg: "#000" },
  { tag: "CLASSROOM", bg: "#1E1E1E", fg: "#FFF" },
  { tag: "CONTENT", bg: "#0F1F0F", fg: "#5CE85C" },
  { tag: "FUND", bg: "#150F1F", fg: "#C47EFF" },
  { tag: "MENTOR", bg: "#1F150A", fg: "#FF9F47" },
];
...
export default function DayInLifeCalendar() {
  ...
  return (
    <section
      className="w-full"
      style={{ background: "#0A0A0A", color: "#FFF", fontFamily: DISPLAY }}
    >
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-10 md:py-28">
        {/* Header */}
        <div
          className="text-[11px] uppercase"
          style={{ color: "#F4C641", letterSpacing: "0.25em", fontFamily: MONO }}
        >
          Tuesday at Masters&apos; Union
        </div>
        <h2 className="mt-5 max-w-[22ch] text-[32px] font-medium leading-[0.98] tracking-[-0.02em] md:text-[52px]">
          This is what a day looks like.
        </h2>
        <p className="mt-4 max-w-[52ch] text-[15px] italic" style={{ color: "#666" }}>
          ...
          {LEGEND.map((l) => (
            <span
              ...
              style={{
                ...
                border: l.tag === "CLASSROOM" ? "1px solid #F4C641" : "none",
              }}
            >
              {l.tag}
            </span>
        ...
        <div className="mt-12 flex flex-col gap-5 md:flex-row">
          <div
            ...
            style={{
              flexBasis: openBlock && !isMobile ? "55%" : "100%",
            ...
            >
              <div className="flex" style={{ height: gridH }}>
                ...
                >
                  ...
                  <div
                    className="absolute left-0 right-0"
                    style={{ top: HOURS * hourH, height: 1, background: "#1A1A1A" }}
                  />
...
function StoryPanel({ block, onClose }: { block: Block; onClose: () => void }) {
  ...
  return (
    <div className="p-6 md:p-8">
      <div className="flex items-start justify-between">
        <span
          ...
          style={{
            ...
            fontFamily: MONO,
            letterSpacing: "0.18em",
            border: block.tag === "CLASSROOM" ? "1px solid #F4C641" : "none",
          }}
        >
          {block.tag}
        </span>
        <button
          onClick={onClose}
          aria-label="Close"
          className="text-[20px] leading-none text-white/60 transition-colors hover:text-white"
        >
          ×
        </button>
      </div>
      ...
      <h3 className="mt-3 text-[24px] font-medium leading-[1.1] tracking-[-0.01em] md:text-[28px]">
        {block.title}
      </h3>
      <div
        className="mt-6"
        style={{ height: 1, background: "#F4C641", opacity: 0.6 }}
      />
      <p
