...
function ReportModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* panel */}
      <div
        className={`report-modal-outer relative grid w-full max-w-[880px] grid-cols-1 overflow-hidden py-6 pl-6 pr-10 gap-6 transition-all duration-300 ease-out md:grid-cols-[38%_62%] ${
      ...
      >
        ...
        <button
          ...
          className="absolute right-10 top-8 z-10 flex size-9 items-center justify-center border border-white/15 text-white/60 transition-colors duration-300 hover:border-[var(--accent)] hover:text-[var(--accent)]"
        >
          <X className="size-4" />
        </button>
