...
export default function FacultyStatsCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="inline-flex items-center justify-center whitespace-nowrap rounded-[999px] border border-black/10 bg-[#CBE4DE]/35 px-[7px] py-1 text-center text-black/70">
          By the numbers
        </span>
        {refreshed ? (
          <>
            <span className="hidden h-3 w-px bg-black/15 sm:block" aria-hidden />
            <span className="inline-flex items-center justify-center whitespace-nowrap rounded-[999px] border border-black/10 bg-[#CBE4DE]/35 px-[7px] py-1 text-center uppercase tracking-[inherit] text-black/70">
              {refreshed}
            </span>
          </>
        ) : null}
