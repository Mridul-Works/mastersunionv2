...
const PROGRAM_STAGES = [
  { name: "Undergraduate", image: undergraduateAsset.url, accent: "#FF7A3D", gradient: "linear-gradient(180deg, #E6C9A8 0%, #F5A87A 40%, #FF7A4D 75%, #F25C3A 100%)", textOn: "#2A1208", pathway: "Build foundations through real-world learning.", offerings: ["Technology & Business", "Data Science & AI", "Finance & Economics", "Psychology & Marketing"], href: "https://mastersunion.org/undergraduate" },
  { name: "Postgraduate", image: postgraduateAsset.url, accent: "#F2A93B", gradient: "linear-gradient(180deg, #FFE3B0 0%, #FFB870 45%, #F28A3C 80%, #C9531E 100%)", textOn: "#2A1605", pathway: "Accelerate your career through execution.", offerings: ["PGP in Technology & Business Management", "Young Leaders Programme", "Career acceleration", "Venture building"], href: "https://mastersunion.org/postgraduate" },
  { name: "Executive", image: executiveAsset.url, accent: "#E0654A", gradient: "linear-gradient(180deg, #F5C8B0 0%, #E89072 40%, #C9533A 80%, #7A2418 100%)", textOn: "#1F0A05", pathway: "Transform leadership through practical learning.", offerings: ["Leadership development", "General management", "Executive programmes", "Applied strategy"], href: "https://mastersunion.org/executive-education" },
  { name: "Immersions", image: immersionAsset.url, accent: "#B8C77A", gradient: "linear-gradient(180deg, #E8E0B5 0%, #B8C77A 45%, #6B8442 80%, #3B5220 100%)", textOn: "#0F1A05", pathway: "Bharat Summer Schools, Travel-Based Learnings, intensive bootcamps.", offerings: ["Bharat Summer Schools", "Travel-Based Learnings", "D2C Bootcamps", "AI Bootcamps"], href: "https://mastersunion.org/experiencesatmastersunion" },
  { name: "Family Business", image: familyBusinessAsset.url, accent: "#9B5DB8", gradient: "linear-gradient(180deg, #E8D0E8 0%, #B584C9 45%, #6E3A8C 80%, #321648 100%)", textOn: "#160820", pathway: "Scale and transform legacy businesses.", offerings: ["Scale legacy businesses", "Navigate succession", "Drive transformation", "Build the next chapter"], href: "https://mastersunion.org/family-business" },
  { name: "AI", image: aiAsset.url, accent: "#6EE2E2", gradient: "linear-gradient(180deg, #D8F2F2 0%, #6EE2E2 40%, #2B7AB8 80%, #0E2B5A 100%)", textOn: "#040E1F", pathway: "Create products and businesses powered by AI.", offerings: ["AI products", "Applied intelligence", "Business automation", "Venture creation"], href: "https://mastersunion.org/ai" },
  { name: "Ventures", image: venturesAsset.url, accent: "#E84A6B", gradient: "linear-gradient(180deg, #F5C6BC 0%, #E8736F 40%, #B22A4A 80%, #4A0F1F 100%)", textOn: "#1A0408", pathway: "Build, launch and fund new ideas.", offerings: ["Incubation", "Funding", "Founder support", "Builder ecosystem"], href: "https://mastersunion.org/student-entrepreneurship" },
  { name: "Global", image: globalAsset.url, accent: "#4A78D8", gradient: "linear-gradient(180deg, #BCD5F2 0%, #6E9CE0 40%, #2B4FB0 80%, #0A1E5C 100%)", textOn: "#050F2E", pathway: "Experience business beyond borders.", offerings: ["Global campuses", "International faculty", "Company visits", "Cross-border networks"], href: "https://mastersunion.org/undergraduate-global" },
  { name: "B2B", image: b2bAsset.url, accent: "#4FB89A", gradient: "linear-gradient(180deg, #C8E8D8 0%, #6EBA94 40%, #2D7A5A 80%, #0E3325 100%)", textOn: "#04140D", pathway: "Transform teams and organizations.", offerings: ["Corporate learning", "Workforce transformation", "Custom programmes", "Leadership academies"], href: "https://mastersunion.org/enterprise" },
] as const;
