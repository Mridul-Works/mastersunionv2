...
const PEDAGOGY = [
  ...
  { icon: ShoppingCart, tag: "D2C Challenge", title: "Graded by the market, not the memo.", body: "Students launch live dropshipping stores and get graded on the market, not the memo. In the PGP TBM 2025 cohort, 75 days of selling produced ₹3.3 Cr+ in revenue and the top store hit ₹45.4 L.", stats: [{ value: "₹3.3 Cr+", label: "Cohort revenue" }, { value: "₹45.4 L", label: "Top team" }, { value: "75 days", label: "Challenge sprint" }], cta: "See the scoreboard", route: "/how-we-teach", bg: "radial-gradient(130% 100% at 20% 20%, #FFDEBF 0%, #FFB07A 45%, #F38434 100%)" },
