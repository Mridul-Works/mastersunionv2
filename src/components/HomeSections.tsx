...
const PATHWAYS: Pathway[] = [
  ...
  },
  {
    ...
    programmes: [
      { title: "PGP in Technology & Business Management — Young Leaders Cohort", duration: "24 Mo", format: "On Campus", href: "/programmes/pg/pgp-tbm" },
      { title: "PGP in Applied AI & Agentic Systems", duration: "15 Mo", format: "On Campus", href: "/programmes/pg/applied-ai-and-agentic-systems" },
      { title: "PGP in UI/UX & AI Product Design", duration: "12 Mo", format: "On Campus", href: "/programmes/pg/ui-ux-and-ai-product-design" },
  ...
  },
  {
    ...
    image: pathwayWork,
    programmes: [
      { title: "PGP in Technology & Business Management", duration: "16 MO", format: "ON CAMPUS", href: "/programmes/pg/pgp-tbm", round: "Round 1", deadline: "2026-08-15T23:59:59", status: "Applications Open", applyHref: "/applications_center" },
      ...
      { title: "PGP Rise: General Management", duration: "1 Yr", format: "Blended Weekend", href: "/programmes/executive/pgp-rise-general-management" },
      { title: "PGP Rise: General Management (Global)", duration: "1 Yr", format: "Online", href: "/programmes/executive/pgp-rise-general-management-global" },
      { title: "PGP in Capital Markets & Trading", duration: "1 Yr", format: "Online/In-Person Weekend", href: "/programmes/executive/capital-markets-and-trading" },
      { title: "Applied Markets & Bloomberg Equity Research", duration: "12–36 Mo", format: "Blended", href: "/programmes/executive/bloomberg-equity-research" },
      { title: "Executive Leadership Programme in AI & GCC Transformation", duration: "6 Mo", format: "Weekend", href: "/programmes/executive/ai-and-gcc-transformation" },
  ...
  },
  {
    ...
    programmes: [
      ...
      { title: "PGP in Entrepreneurship & Business Acceleration", duration: "9 Mo", format: "Blended", href: "/programmes/executive/entrepreneurship-and-business-acceleration" },
...
function SessionFeedCard({
  ...
  return (
    <article className="w-[300px] shrink-0 snap-start sm:w-[330px]">
      ...
      {/* poster placeholder */}
      <div className="relative mt-4 aspect-[4/5] w-full overflow-hidden bg-[#EFEBE2]">
        <div
          className="absolute inset-0 bg-gradient-to-br from-[#F6F2E9] via-[#EAE5DA] to-[#DFD9CC]"
          style={{
            backgroundImage:
  ...
  return (
    <div className="col-span-12 mt-9 border-t border-black/10 pt-8">
      ...
      <div className="relative" onMouseMove={edgeScroll.onMouseMove} onMouseLeave={edgeScroll.onMouseLeave}>
        ...
        <EdgeHint side="left" active={edgeScroll.edge === -1} />
        <EdgeHint side="right" active={edgeScroll.edge === 1} />
      </div>
