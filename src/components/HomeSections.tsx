...
const PEDAGOGY = [
  ...
  { icon: GraduationCap, tag: "Faculty", title: "Your professor closed a deal this morning.", body: "40% of faculty are sitting CEOs, MDs and CXOs. 30% visiting from Harvard, Wharton, Kellogg and Booth. The slides update on Monday morning.", stats: [{ value: "40%", label: "Industry practitioners" }, { value: "200+", label: "Visiting experts" }, { value: "30%", label: "Ivy-league visiting" }], cta: "Meet the faculty", route: "/faculty", bg: "radial-gradient(130% 100% at 20% 15%, #FFD3E4 0%, #F49AC2 45%, #E15C93 100%)", img: edExecutive.url },
  { icon: Globe, tag: "Immersions", title: "Study the world where the world actually works.", body: "Optional immersion modules in Terms 4 & 5 — Silicon Valley, Dubai, Singapore, London for Global; Tier-2/3 India factory floors, family businesses and D2C hubs for Bharat.", stats: [{ value: "12", label: "Partner B-schools" }, { value: "40+", label: "Fortune 500 offices" }, { value: "12+", label: "Bharat cities" }], cta: "See the immersions", route: "/immersions", bg: "radial-gradient(130% 100% at 25% 25%, #C7EBD8 0%, #7EC9A7 45%, #2F8E68 100%)", img: edImmersions.url },

  { icon: Rocket, tag: "Entrepreneurship", title: "Graduate with a cap table, not just a CV.", body: "An on-campus venture studio that handles incorporation, hiring, and warm intros to Sequoia, Blume and Y Combinator. Six alumni on Shark Tank India.", stats: [{ value: "30+", label: "Active startups" }, { value: "₹593 Cr", label: "Combined valuation" }, { value: "6", label: "On Shark Tank India" }], cta: "See the startups", route: "/startups", bg: "radial-gradient(130% 100% at 80% 25%, #DECBFF 0%, #B8A4F5 45%, #8770E8 100%)", img: edVentures.url },
  { icon: Briefcase, tag: "Career", title: "Every graduate placed. No asterisks.", body: "28% of grads join as Founder's Office or Chief of Staff. 3× average pre-MBA salary jump and 10–20% annual growth post-grad.", stats: [{ value: "₹61.98L", label: "Highest CTC" }, { value: "3×", label: "Average salary jump" }, { value: "100%", label: "Placement" }], cta: "Read the report", route: "/placements", bg: "radial-gradient(130% 100% at 25% 80%, #EDF7B0 0%, #C6E26A 45%, #94BE35 100%)", img: edPostgrad.url },
  { icon: Users, tag: "Mentor Union", title: "500 operators. One text away.", body: "Founders mid-build, investors mid-cheque, CMOs mid-quarter. No office hours, no waiting lists — just answers when you need them.", stats: [{ value: "500+", label: "Mentors" }, { value: "<1 hr", label: "Median response" }, { value: "On demand", label: "Always on" }], cta: "Browse mentors", route: "/mentors", bg: "radial-gradient(130% 100% at 75% 25%, #D4E6FF 0%, #8FB8F5 50%, #4F86DE 100%)", img: edB2B.url },
  { icon: ShoppingCart, tag: "D2C Challenge", title: "Graded by the market, not the memo.", body: "Students launch live dropshipping stores and get graded on the market, not the memo. In the PGP TBM 2025 cohort, 75 days of selling produced ₹3.3 Cr+ in revenue and the top store hit ₹45.4 L.", stats: [{ value: "₹3.3 Cr+", label: "Cohort revenue" }, { value: "₹45.4 L", label: "Top team" }, { value: "75 days", label: "Challenge sprint" }], cta: "See the scoreboard", route: "/how-we-teach", bg: "radial-gradient(130% 100% at 20% 20%, #FFDEBF 0%, #FFB07A 45%, #F38434 100%)", img: edGlobal.url },
  { icon: Mic, tag: "Creator Challenge", title: "Leave campus with an audience, not just a degree.", body: "A full content studio on campus where students grow personal brands on YouTube, Instagram and LinkedIn. Recent winners hit 1.2M impressions and 120K unique viewers.", stats: [{ value: "1.2M+", label: "Impressions" }, { value: "120K", label: "Unique viewers" }, { value: "₹2 L", label: "Winner prize" }], cta: "See the creators", route: "/creator-challenge", bg: "radial-gradient(130% 100% at 80% 80%, #FFC0CE 0%, #FF8AA8 45%, #E54E7C 100%)", img: edAI.url },
  { icon: ChefHat, tag: "Food Lab", title: "The only B-school with an FSSAI licence.", body: "Lexi's went from a classroom concept to Gurgaon's highest-rated sandwich brand. FSSAI-certified production line, 4.5★ on Zomato, ₹1 Cr+ ARR.", stats: [{ value: "4.5★", label: "Zomato rating" }, { value: "₹1 Cr+", label: "Student brand ARR" }, { value: "FSSAI", label: "Certified" }], cta: "Tour the lab", route: "/food-lab", bg: "radial-gradient(130% 100% at 30% 30%, #BFF3D9 0%, #7AD9A8 45%, #33B876 100%)", img: edFamily.url },
