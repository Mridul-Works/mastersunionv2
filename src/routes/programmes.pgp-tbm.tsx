          ...
          <div className="relative mt-10 -mx-5 md:-mx-10">
            ...
            >
              {filtered.map((a, i) => (
                ...
                >
                  {/* Portrait */}
                  <div className="relative aspect-[4/5] w-full overflow-hidden bg-[#EDEAE4]">
                    <img
                      src={a.image}
                      alt={a.name}
                      loading="lazy"
                      className="h-full w-full object-contain object-center grayscale transition-all duration-700 ease-out group-hover:scale-[1.03] group-hover:grayscale-0"
                    />
