      ...
      <div className={innerClass}>
        ...
        <div className="overflow-x-auto">
          ...
          >
            ...
            <div className="grid grid-cols-[200px_repeat(8,1fr)] divide-x divide-foreground/10 bg-smoke-200 text-white">
                ...
                {row.cells.map((cell, i) => {
                  ...
                  return (
                    <div
                      key={t}
                      onMouseEnter={() => setActive(t)}
                      className={`group relative flex min-h-[76px] flex-col justify-between px-3 py-3 transition-colors ${isActive ? "bg-smoke-200 text-white" : "bg-white"}`}
                    >
