          ...
          <div className="mx-auto flex h-full w-full max-w-[1440px] flex-col px-5 md:px-10">
            <div className="flex flex-1 flex-col justify-end pb-[72px] md:pb-[88px]">
              <div className="@container relative border border-background/15 md:border-0">
                ...
                <span aria-hidden className="absolute -left-[6.5px] -top-[6.5px] hidden size-[13px] rotate-45 bg-background md:block" />
                <span aria-hidden className="absolute -bottom-[6.5px] -right-[6.5px] hidden size-[13px] rotate-45 bg-background md:block" />
                {/* 4 edge-midpoint diamonds */}
                <span aria-hidden className="absolute -top-[6.5px] left-1/2 hidden size-[13px] -translate-x-1/2 rotate-45 bg-background md:block" />
                <span aria-hidden className="absolute -bottom-[6.5px] left-1/2 hidden size-[13px] -translate-x-1/2 rotate-45 bg-background md:block" />
                <span aria-hidden className="absolute -left-[6.5px] top-1/2 hidden size-[13px] -translate-y-1/2 rotate-45 bg-background md:block" />
                <span aria-hidden className="absolute -right-[6.5px] top-1/2 hidden size-[13px] -translate-y-1/2 rotate-45 bg-background md:block" />
                {/* center diamond */}
                <span aria-hidden className="absolute left-1/2 top-1/2 hidden size-[13px] -translate-x-1/2 -translate-y-1/2 rotate-45 bg-background md:block" />
                {/* full cross-divider */}
