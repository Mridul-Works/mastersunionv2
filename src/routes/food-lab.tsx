...
function Page() {
  return (
    <main className="min-h-screen bg-white pb-16 text-black md:pb-18" style={{ fontFamily: INTER }}>
      ...
      <section id="problem" className="mx-auto max-w-6xl px-5 pt-14 md:px-10 md:pt-18">
        ...
        <div className="mt-8 grid grid-cols-1 gap-px bg-black/10 md:grid-cols-2">
          {PROBLEMS.map((p) => (
        ...
        <div className="mt-8 border border-black/15 bg-neutral-50 p-8 md:p-10">
      ...
      <section id="solution" className="mt-14 border-t border-black/10 bg-neutral-50 md:mt-18">
      ...
      <section id="mentors" className="mx-auto max-w-6xl px-5 pt-14 md:px-10 md:pt-18">
        <div className="text-[11px] uppercase tracking-[0.3em] text-black/55" style={{ fontFamily: MONO }}>Mentors &amp; Partners</div>
        <div className="mt-7 grid grid-cols-1 gap-px bg-black/10 md:grid-cols-2 lg:grid-cols-4">
          {MENTORS.map((m) => (
