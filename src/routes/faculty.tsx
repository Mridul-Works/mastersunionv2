...
import vfShad from "@/assets/faculty/visiting/shad-morris.webp.asset.json";
    ...
    <div className={`mt-[clamp(1rem,2.5vh,2rem)] border-t ${dark ? "border-white/15" : "border-black/15"}`}>
      ...
      >
          {items.map((item, index) => (
            <article key={`${item.name}-${index}`} className="faculty-profile" data-faculty-reveal>
...
function FacultyPage() {
  ...
  return (
    <main ref={pageRef} className="ink-scope faculty-redesign min-h-screen bg-ink pb-24 text-foreground sm:pb-[clamp(4.5rem,7vw,6rem)]" style={{ fontFamily: INTER }}>
      ...
      <div className="flex h-[calc(100svh-var(--nav-reserve,0px))] flex-col bg-ink">
        <HeroFadeOut>
          <FacultyHero />
        </HeroFadeOut>
      </div>
      ...
      <section id="cta" className="faculty-placement-closing placements-obsidian placements-ug-v2 relative overflow-hidden border-t border-white/10 text-white">
        ...
        <div className="page-x relative z-10 py-10 sm:py-12 md:py-14">
          <div className="placements-section-shell placements-section-shell-dark faculty-placement-closing-panel">
            ...
            <h2 className="placements-section-title mt-7 max-w-[22ch] text-white">
              Learn from the people <em className="font-serif-italic">doing it — not just studying it.</em>
            </h2>
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <Link to="/applications_center" className="placements-pill-accent group inline-flex items-center gap-2 px-7 py-3.5 text-[13px] font-medium">
              ...
              <a href="https://mastersunion.org/become-a-master" target="_blank" rel="noreferrer" className="placements-pill-ghost group inline-flex items-center gap-2 px-7 py-3.5 text-[13px] font-medium">
                Or join them
                <ArrowUpRight className="size-3.5 transition-transform duration-500 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
              </a>
            </div>
