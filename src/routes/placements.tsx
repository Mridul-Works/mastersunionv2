          ...
          <div className="career-story-toolbar">
            ...
            <div className="career-story-arrows">
              <button
                ...
                className="career-nav-arrow inline-flex h-8 w-8 items-center justify-center rounded-full border border-black/20 text-black/60 transition-all hover:border-[#638C75] hover:bg-[#638C75] hover:text-white"
              >
    ...
    >
      <div className="page-x py-16 md:py-24">
        ...
        <div className="placement-data-bento grid overflow-hidden border border-white/15 lg:grid-cols-12">
          ...
          <div className="relative flex min-h-[260px] flex-col items-center justify-center overflow-hidden p-7 pb-0 md:p-10 lg:col-span-5">
