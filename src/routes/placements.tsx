      ...
      {AUDIT_STATS.map((stat, i) => (
        ...
        >
          <div className="relative z-10 flex flex-col items-center justify-center gap-2 px-2 py-4 sm:gap-4 sm:px-5 sm:py-6 md:px-7 md:py-7 lg:px-8 lg:py-8">
            ...
            <span
              className={cn(
                "metric-index text-[9px] tabular-nums tracking-[0.28em] transition-colors duration-500 sm:text-[10px]",
            ...
            <span
              className={cn(
                "metric-value text-center text-[clamp(1.1rem,3.2vw,2.6rem)] font-medium leading-none tracking-[-0.04em] transition-colors duration-500",
            ...
            <div className="flex flex-col items-center gap-1 text-center sm:gap-1.5">
              <span
                className={cn(
                  "metric-label text-center text-[9px] font-semibold uppercase tracking-[0.14em] transition-colors duration-500 sm:text-[11px] sm:tracking-[0.16em]",
              ...
              <p
                className={cn(
                  "metric-note max-w-[18ch] text-center text-[10px] leading-tight transition-colors duration-500 sm:text-[13px] sm:leading-snug",
