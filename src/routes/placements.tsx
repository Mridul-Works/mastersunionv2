      ...
      >
        {PODCAST_RAIL_VIDEOS.map((item) => (
          <button
            ...
            className="group flex w-[calc(100%-1rem)] shrink-0 snap-start flex-col pt-8 text-left sm:w-[min(260px,78vw)] sm:pt-0"
          >
      ...
      <div className="flex min-w-0 w-full flex-col">
        ...
        >
          {REPORT_YEARS.map((y, i) => (
            <Reveal key={y} delay={i * 70} y={16} className="shrink-0 snap-start h-full w-[calc(100%-1rem)] sm:w-[min(320px,78vw)]">
