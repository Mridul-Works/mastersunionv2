          ...
          <div ref={copyRef} className="mt-8 max-w-[600px] md:mt-14" style={{ willChange: "transform, opacity" }}>
            ...
            <div className="mt-8 flex flex-wrap gap-3 md:mt-14" style={step(860, 18)}>
              ...
              >
                ...
                />
                <span className="relative z-10 inline-flex items-center gap-2 text-black transition-colors duration-500 group-hover:text-black">
                  <Download className="size-3.5 text-black transition-all duration-500 group-hover:text-black group-hover:translate-y-0.5" /> Placement report
                </span>
              </a>
              <a
                href="#recruiters"
